...
export interface BizData {
  ...
  shipFromWarehouseCode: ShipFromWarehouseCode;
  shippingFee: string;
...
export interface DxTemplateInfo {}
...
export interface ShipFromWarehouseCode {
  CN: string[];
}
